...
if (isset($_POST['ppbutton'])) {
  ...
  setcookie("category1", $category, time()+(86400*1));
  setcookie("location1", $location, time()+(86400*1));
  setcookie("title1", $title, time()+(86400*1));
  setcookie("condition1", $condition, time()+(86400*1));
  setcookie("authenticity1", $authenticity, time()+(86400*1));
  setcookie("price1", $price, time()+(86400*1));
  setcookie("feature1", $features, time()+(86400*1));
